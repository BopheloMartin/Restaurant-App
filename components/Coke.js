...
export default function Coke({ navigation }) {
    return (
        <View style={styles.container}>

            <Box style={styles.box1}>
                <Image source={CokeDrink} style={styles.image} />
            </Box>

            <Box style={{ marginTop: 25 }}>
                <Text style={{ color: 'white' }}> Coca-Cola Soft Drink </Text>
            ...
            <Text style={{ color: 'white', marginTop: 19, marginLeft: 5 }}> Classic cold cherry coke </Text>
