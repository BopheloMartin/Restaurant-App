...
export default function Burgerpage({ navigation }) {
    return (
        <View style={styles.container}>

            <Box style={styles.box1}>
                <Image source={BaconCheese} style={styles.image} />
            </Box>

            <Box style={{ marginTop: 25}}>
                <Text style={{ color: 'white' }}>Double Bacon Burger</Text>

                <Text style={{ color: 'white', marginLeft: 100 }}>R100</Text>
            ...
            <Text style={{ color: 'white', marginTop: 19, marginLeft: 5 }}>This double bacon burger uses classic cheese <br></br> with 100% quality beef,
