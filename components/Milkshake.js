    ...
    return (
        <View style={styles.container}>
            ...
            <Box style={styles.box1}>
                <Image source={OreoMilkshake} style={styles.image} />
            </Box>

            <Box style={{ marginTop: 25}}>
                <Text style={{ color: 'white' }}> Oreo Nutella Milkshake </Text>
            ...
            <Text style={{ color: 'white', marginTop: 19, marginLeft: 5 }}>This Oreo Nutella Milkshake uses the old classic <br></br> ores 
                and the sweet chocolate flavoured nutella.
            </Text>
